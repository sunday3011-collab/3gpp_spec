...
![](images/38.202_PHY_Services_j00/fig-0001.emf) ![](images/38.202_PHY_Services_j00/fig-0002.png)
...
![](images/38.202_PHY_Services_j00/fig-0003.emf)
...
- Multi-antenna processing;
- Support of L1 control and Hybrid-ARQ-related signalling.
![](images/38.202_PHY_Services_j00/fig-0004.emf)
...
- Mapping to physical resource;
- Multi-antenna processing.
![](images/38.202_PHY_Services_j00/fig-0005.emf)
...
- Mapping to physical resource;
- Multi-antenna processing.
![](images/38.202_PHY_Services_j00/fig-0006.emf)
...
- Multi-antenna processing;
- Support of L1 control and Hybrid-ARQ-related signalling.
![](images/38.202_PHY_Services_j00/fig-0007.emf)
...
- Mapping to physical resource;
- Multi-antenna processing.
![](images/38.202_PHY_Services_j00/fig-0008.emf)
...
| p' x D | Note 3, Note 5 |
| $\tilde{j}\times$ A + $\tilde{k}\times$B | Note 6 |
| $\tilde{j}\times$ A + $\tilde{(\sum_{i=1}^{\tilde{p}} \tilde{m}_{i})}\times$C | Note 6, Note 10 |
| $\tilde{j}\times$ A + $\tilde{p}'\times$D | Note 6 |
| $\hat{k}\times$ B + $\hat{(\sum_{i=1}^{\hat{p}} \hat{m}_{i})}\times$C | Note 8, Note 10 |
| B + $(\sum_{i=1}^{\hat{p}'} \hat{m}_{i}^{'}) \times$C | Note 9, Note 10 |
| $\tilde{k}\times$ B + $\tilde{p}'\times$D | Note 7 |
| $(\sum_{i=1}^{\tilde{p}} \tilde{m}_{i}) \times$C + $\tilde{p}'\times$D | Note 7, Note 10 |
