3GPP TS 38.304 V19.3.0 (2026-06)
...
(Release 19)
![](images/38.304_UE_Idle_j30/fig-0001.emf) ![](images/38.304_UE_Idle_j30/fig-0002.emf)
...
4 General description of RRC_IDLE state and RRC_INACTIVE state 11
4.1 Overview 11
4.2 Functional division between AS and NAS in RRC_IDLE state and RRC_INACTIVE state 13
4.3 Service types in RRC_IDLE state 16
4.4 Service types in RRC_INACTIVE state 16
4.5 Cell Categories 16
5 Process and procedure descriptions 18
5.1 PLMN selection and SNPN selection 18
5.1.1 Support for PLMN selection 18
5.1.1.1 General 18
5.1.1.2 NR case 18
5.1.1.3 E-UTRA case 18
5.1.2 Support for SNPN selection 19
5.1.2.1 General 19
5.1.2.2 NR case 19
5.2 Cell selection and reselection 19
5.2.1 Introduction 19
5.2.2 States and state transitions in RRC_IDLE state and RRC_INACTIVE state 20
5.2.3 Cell Selection process 21
5.2.3.1 Description 21
5.2.3.2 Cell Selection Criterion 22
5.2.3.3 E-UTRAN case in Cell Selection 23
5.2.4 Cell Reselection evaluation process 23
5.2.4.1 Reselection priorities handling 23
5.2.4.2 Measurement rules for cell re-selection 26
5.2.4.3 Mobility states of a UE 28
5.2.4.3.0 Introduction 28
5.2.4.3.1 Scaling rules 28
5.2.4.4 Cells with cell reservations, access restrictions or unsuitable for normal camping 29
5.2.4.5 NR Inter-frequency and inter-RAT Cell Reselection criteria 29
5.2.4.6 Intra-frequency and equal priority inter-frequency Cell Reselection criteria 30
5.2.4.7 Cell reselection parameters in system information broadcasts 31
5.2.4.7.0 General reselection parameters 31
5.2.4.7.1 Speed dependent reselection parameters 34
5.2.4.7.2 Slice-based cell reselection parameters 34
5.2.4.8 Inter-RAT Cell reselection in RRC_INACTIVE state 35
5.2.4.9 Relaxed measurement 35
5.2.4.9.0 Relaxed measurement rules 35
5.2.4.9.1 Relaxed measurement criterion for UE with low mobility 36
5.2.4.9.2 Relaxed measurement criterion for UE not at cell edge 37
5.2.4.9.3 Relaxed measurement criterion for a stationary (e)RedCap UE 37
5.2.4.9.4 Relaxed measurement criterion for a stationary (e)RedCap UE not at cell edge 37
5.2.4.10 Cell reselection with CAG cells 37
5.2.4.11 Reselection priorities for slice-based cell reselection 38
5.2.4.12 Relaxed measurement and measurement offloading for UE supporting LP-WUS 39
5.2.4.12.1 Relaxed measurement rules 39
5.2.4.12.2 Relaxed measurement criterion 39
5.2.4.12.3 Serving cell measurement offloading rules 40
5.2.4.12.4 Serving cell measurement offloading criterion 40
5.2.4.12.5 Low mobility criterion for LP-WUS 41
5.2.5 Camped Normally state 41
5.2.6 Selection of cell at transition to RRC_IDLE or RRC_INACTIVE state 42
5.2.7 Any Cell Selection state 42
5.2.8 Camped on Any Cell state 42
5.3 Cell Reservations and Access Restrictions 43
5.3.0 Introduction 43
5.3.1 Cell status and cell reservations 43
5.3.2 Unified access control 48
5.4 Tracking Area registration 48
5.5 RAN Area registration 48
6 Reception of broadcast information 48
6.1 Reception of system information 48
6.2 Reception of MBS 49
7 Paging 49
7.1 Discontinuous Reception for paging 49
7.2 Paging Early Indication 52
7.2.1 Paging Early Indication reception 52
7.3 Subgrouping for PEI 53
7.3.0 General 53
7.3.1 CN assigned subgrouping 54
7.3.2 UE_ID based subgrouping 54
7.4 Paging in extended DRX 54
7.5 LP-WUS monitoring 56
7.5.0 General 56
7.5.1 Condition for LP-WUS monitoring 57
7.6 Subgrouping for LP-WUS 58
7.6.0 General 58
7.6.1 CN assigned subgrouping 58
7.6.2 UE_ID based subgrouping 58
8 Sidelink Operation 59
8.1 NR sidelink communication, and V2X sidelink communication, NR sidelink discovery, and ranging/ sidelink positioning 59
8.2 Cell selection and reselection for Sidelink 60
8.2.1 Parameters used for cell selection and reselection triggered for sidelink 60
9 Tracking Reference Signal 60
Annex A (informative): Example of Hashed ID Calculation using 32-bit FCS 61
...
![](images/38.304_UE_Idle_j30/fig-0003.wmf)
...
SSearchDeltaP-LPWUS
This specifies the threshold (in dB) on Srxlev or RX level variation to evaluate low mobility criterion for LP-WUS for serving cell and neighbouring cell measurement relaxation.
...
TSearchDeltaP-LPWUS
This specifies the time period over which the Srxlev or RX level variation is evaluated for low mobility criterion for LP-WUS for serving cell and neighbouring cell measurement relaxation.
...
#### 5.2.4.12 Relaxed measurement and measurement offloading for UE supporting LP-WUS
...
##### 5.2.4.12.1 Relaxed measurement rules
...
##### 5.2.4.12.2 Relaxed measurement criterion
...
Or,
- If lowMobilityEvaluationLPWUS is configured and the UE supports low mobility criterion for LP-WUS as defined in clause 5.2.4.12.5:
- Srxlev > SLP_WUS_Threshold2P_MR, and,
- Qrxlevmeas_lr > QLP_WUS_Threshold2P_LR, if QLP_WUS_Threshold2P_LR is configured, and,
- The low mobility criterion for LP-WUS as defined in clause 5.2.4.12.5 is fulfilled for a period of TSearchDeltaP-LPWUS.
Where:
- Srxlev = current Srxlev value of the serving cell (dB).
- Squal = current Squal value of the serving cell (dB).
...
- SLP_WUS_Threshold2P_MR: The second Srxlev threshold for the criterion for serving cell and neighbouring cell measurement relaxation based on MR when lowMobilityEvaluationLPWUS is configured.
...
- QLP_WUS_Threshold2P_LR: The cell RX level second threshold for the criterion for serving cell and neighbouring cell measurement relaxation based on LR when lowMobilityEvaluationLPWUS is configured.
...
##### 5.2.4.12.4 Serving cell measurement offloading criterion
...
##### 5.2.4.12.5 Low mobility criterion for LP-WUS
When MR measurements are used the low mobility criterion for LP-WUS is fulfilled when:
- (SrxlevRef – Srxlev) < SSearchDeltaP-LPWUS,
Where:
- Srxlev = current Srxlev value of the serving cell (dB).
- SrxlevRef = reference Srxlev value of the serving cell (dB) set as follows:
- After selecting or reselecting a new cell, or,
- If (Srxlev - SrxlevRef) > 0, or,
- If the relaxed measurement criterion has not been met for TSearchDeltaP-LPWUS, or,
- When the measurement type is changed from LR to MR measurements:
- The UE shall set the value of SrxlevRef to the current Srxlev value of the serving cell.
When LR measurements are used the low mobility criterion for LP-WUS is fulfilled when:
- (Qrxlevmeas_lrRef – Qrxlevmeas_lr) < SSearchDeltaP-LPWUS,
Where:
- Qrxlevmeas_lr = current measured cell RX level value of the serving cell (dBm) based on LR (RSRP).
- Qrxlevmeas_lrRef = reference RX level value of the serving cell (dBm) based on LR (RSRP), set as follows:
- After selecting or reselecting a new cell, or,
- If (Qrxlevmeas_lr - Qrxlevmeas_lrRef) > 0, or,
- If the relaxed measurement criterion has not been met for TSearchDeltaP-LPWUS, or,
- When the measurement type is changed from MR to LR measurements:
- The UE shall set the value of Qrxlevmeas_lrRef to the current RX level value of the serving cell.
It is up to UE implementation which measurement type to use for the evaluation of low mobility criterion, i.e. on MR or on LR (OOK based or OFDM based). When the entry condition for serving cell and further neighbouring cell measurement relaxation is fulfilled and measurements on LR are available, then the UE shall use LR measurements.
...
For a UE supporting paging adaptation and PEI, if pagingAdaptPEI-Config is signaled in system information, the UE in RRC_IDLE or RRC_INACTIVE state can monitor the PEI occasion according to pagingAdaptPEI-Config, pei-FrameOffset-r19 and pagingAdaptFirstPDCCH-MonitoringOccasionOfPEI-O. For a UE supporting paging adaptation and PEI, if pei-Config-r17 is configured and pagingAdaptationPEI-Config-r19 is absent, the UE in RRC_IDLE or RRC_INACTIVE state can monitor the PEI occasion according to pei-Config-r17.
## 7.3 Subgrouping for PEI
### 7.3.0 General
...
### 7.5.0 General
The UE supporting LP-WUS may monitor LP-WUS in RRC_IDLE and RRC_INACTIVE states in order to reduce power consumption. If LP-WUS configuration is provided in system information, the UE in RRC_IDLE or RRC_INACTIVE state supporting LP-WUS (except for the UEs expecting MBS group notification) may start LP-WUS monitoring using LP-WUS parameters in system information according to the procedure described below if the entry condition in clause 7.5.1 is fulfilled. The UE may stop LP-WUS monitoring and follow the paging monitoring procedure as described in clause 7.1 or 7.2 if the exit condition in clause 7.5.1 is fulfilled. LP-WUS monitoring can be disabled in the UE via NAS signalling as specified in TS 23.501 [10]. If LP-WUS disabled indication via NAS signalling is absent, LP-WUS monitoring is enabled.
...
- Otherwise if the gap between the end of the last LP-WUS MO the UE would monitor in the LO associated with the value in offsetForLongerWakeUpDelay and the start of the corresponding PO is no less than the wake-up delay a UE reports, the UE monitors the LO associated with the value in offsetForLongerWakeUpDelay;
- Otherwise, the UE follows the paging monitoring procedure as described in clause 7.1 or 7.2.
If the UE in RRC_IDLE and RRC_INACTIVE is unable to monitor the LP-WUS occasion in all MOs corresponding to its PO, the UE follows the paging monitoring procedure as described in clause 7.1 or 7.2.
...
### 7.5.1 Condition for LP-WUS monitoring
...
In multi-beam operations, measured cell RX level value and measured cell quality value of the serving cell based on LR are up to UE implementation.
## 7.6 Subgrouping for LP-WUS
### 7.6.0 General
...
N: number of total paging frames in T, which is the DRX cycle of RRC_IDLE state as specified in clause 7.1
Ns: number of paging occasions for a PF
Np: number of subgroups for UE_ID based subgrouping in a PO for PEI (subgroupsNumForUEID), if broadcast in system information and UE supports PEI; otherwise, Np is 1
UE_ID: 5G-S-TMSI mod 1048576
lp-SubgroupsNumForUEID and lp-SubgroupsNumPerPO are the subgroup number for UE_ID based subgrouping for LP-WUS in a PO and the total subgroup number for LP-WUS in a PO, respectively.
In RRC_INACTIVE state with CN configured PTW, the subgroup ID of the UE for LP-WUS used outside CN PTW is the same as the subgroup ID of the UE for LP-WUS used inside CN PTW.
...
| 06/2026 | RP-112 | RP-261440 | 0458 | 6 | F | Low mobility criterion for LP-WUS | 19.3.0 |
|  | RP-112 | RP-261438 | 0459 | 2 | F | Clarification for UE behaviour when pagingAdaptationPEI-Config-r19 is absent | 19.3.0 |
|  | RP-112 | RP-261440 | 0461 | 1 | D | Miscellaneous modifications for LP-WUS to TS 38.304 | 19.3.0 |
