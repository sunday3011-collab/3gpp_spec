...
默认扫描 `3gpp-wiki/` (v1)。处理 v2 等其它 wiki 时用环境变量覆盖:
  WIKI_DIR=3gpp-wiki-v2 python3 scripts/gen_section_index.py
...
# 用 WIKI_DIR 覆盖目标 wiki (默认 3gpp-wiki 即 v1); SPECS_ROOT / OUT 随之推导
WIKI_DIR = os.environ.get("WIKI_DIR", "3gpp-wiki")
