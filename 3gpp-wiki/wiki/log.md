...
## [2026-06-21] ingest | 蒸馏页专家审查修复 | 影响页面：38.211/331/321/322/323
- 修正 38.211 numerology：μ=0..6（含 480/960kHz FR2-2），扩展CP仅μ=2
- RRC 补测量事件 A1-A6/B1-B2(+I1/C/D/T1/X/Y) §5.5.4 与 SIB 体系 §5.2
- MAC 补 BSR 触发(Regular/Periodic/Padding)/格式 与 HARQ 进程数(§5.3.2/5.4.2)
- RLC 补 PDU 类型(TMD/UMD/AMD/STATUS)；PDCP 补 PDU 类型与完整性默认
- 修复 [[PHY/README]] 撞名 wikilink → 指向具体 spec 页

## [2026-06-21] ingest | 非热点协议全量蒸馏(27页) | 影响页面：27 个 compiled 概览页升级为蒸馏页
